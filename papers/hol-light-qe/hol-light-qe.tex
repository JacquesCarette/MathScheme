...
metatheorems as conjectures since their proofs have not yet been
written down.
...
when loaded in {\HLQE}.  A further test would be to load a variety of
large {\HL} proofs in {\HLQE}.
...
proved in~\cite{Farmer18}.  This theorem is proved by just imitating
the proof for {\churchqe}. $\Box$
...
every model of {\HL} can be expanded to a model of the {\HLQE}.
$\Box$
...
biform theories encoding natural number of arithmetic described
