...
\title{{\HLQE}\thanks{Published in: J.~Avigad and A. Mahboubi, eds.,
    \emph{Interactive Theorem Proving}, Vol.~10895, pp.~215--234,
    Springer, 2018.  This research was supported by NSERC.}}

\author{Jacques Carette, William M. Farmer, and Patrick Laskowski}

\institute{%
Computing and Software, McMaster University, Canada\\
%\email{\{carette,wmfarmer,laskowsp\}@mcmaster.ca}\\
