...
example of a logical system build by modifying {\HL}.)
...
{\qzero}'s proof system).  As a result, every proof that is valid in
{\HL}'s proof system will also be valid in {\HLQE}'s proof system.
$\Box$
...
proved in~\cite{}.  We believe we can prove this theorem by just
