...
\renewcommand{\pf}{$\mbox{\sc PF}$}
\renewcommand{\pfstar}{$\mbox{\sc PF}^\ast$}
\renewcommand{\lutins}{\mbox{\sc LUTINS}}
\renewcommand{\nbgstar}{$\mbox{\sc NBG}^\ast$}
\renewcommand{\stmm}{\mbox{\sc STMM}}
...
\be
  ...
  \bi
    ...
    \item Undefinedness: \pf, \pfstar, {\lutins}, {\nbgstar}, {\stmm},
      {\qzerou}.
