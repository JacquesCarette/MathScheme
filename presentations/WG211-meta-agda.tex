...
%\section{Context, goals, method}

\begin{frame}
\frametitle{The Big Picture: MetaProgramming on Theories}
\begin{center}
...
Biform theories \\
{\huge $\Downarrow$} \\
\color<2>{blue}Generic algorithm\\
{\huge $\Downarrow$} \\
Library \\
{\huge $\Downarrow$} \\
Efficient Program
...
Back down!  Given:
\begin{itemize}
\item The theory presentation of 2-categories, can you specialize to category?
\item Category to monoid?
\item Monoidal Category to... monoid?
\item Braided Category to... ?
\end{itemize}
\vspace*{1cm}
\begin{itemize}
\item How do you (as a library builder) not repeat yourself,
\item while giving end-users a huge, rich, as-they-expect it to look library?
\end{itemize}
\end{frame}
